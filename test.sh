...
(sleep 0.5; for i in `seq 1 20`; do echo "msg 0 0 Packet: $i"; sleep 0.01; done; sleep 10; echo "exit") | ./tritontalk -c 0.9 -r 1 -s 1 > .output.3 2> .debug_output.3
...
(sleep 0.5; for i in `seq 1 30`; do echo "msg 0 0 Packet: $i"; sleep 0.1; done; sleep 5; echo "exit") | ./tritontalk -d 0.2 -c 0.2 -r 1 -s 1 > .output.4 2> .debug_output.4

(for i in `seq 1 30`; do echo "<RECV_0>:[Packet: $i]"; done) > .expected_output.4
